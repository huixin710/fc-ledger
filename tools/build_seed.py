...
# ─────────────────────────────────────────────────────────────
FED_MAIN = '聯邦 M 卡萬事達 0206'    # 月額/年額費刷這張（帳單顯示 FAM TOKYO）
FED_LINE = '聯邦幫賴點卡 Visa 9908'  # NAGOYA 扭蛋刷這張
TS = '台新 Richart Visa 0602'
...
# ─────────────────────────────────────────────────────────────
C36, C22 = '國泰 CUBE Visa 3624', '國泰蝦皮萬事達 2225'
...
# E. 4511 / 6357 卡
# ─────────────────────────────────────────────────────────────
add('115/8/5',  '115/8/10', 'Ｈａｍｉ　Ｐｏｉｎｔ', 1532, '中信 All Me 萬事達 4511', '電信網路')
add('115/8/16', '115/8/20', '健身工廠－草屯廠', 888, '中信 All Me 萬事達 4511', '運動健身')
add('115/5/23', '115/7/28', '綜所稅單筆０３－０６', 330, '中信 LINE Pay JCB 6357', '稅費保險')
add('115/8/18', '115/8/24', '全國加油站樹王自助', 130, '中信 LINE Pay JCB 6357', '交通')
add('115/8/23', '115/8/24', '台灣薩莉亞餐飲股份有限', 270, '中信 LINE Pay JCB 6357', '餐飲')
...
add('115/8/6',  '115/8/11', 'Yibor Technology Co., Lim HONG KONG', 10799,
    '聯邦 LINE Bank Visa 1308', '其他', 'TWD', 10799, 162)
...
# ─────────────────────────────────────────────────────────────
FB, FB2 = '富邦 momo 卡萬事達 6848', '富邦 Costco 萬事達 0969'
...
CARD_META = {
    T32:                          meta(7, 22, False),   # 台新帳單白紙黑字
    TS:                           meta(7, 22, False),
    '台新 Richart 萬事達 6209':    meta(7, 22),          # 同系列推測相同
    HY:                           meta(2, 18),          # 入帳到 09/01、自動轉帳 08/18
    C36:                          meta(27, 15),         # 入帳到 08/26
    C22:                          meta(27, 15),
    FED_MAIN:                     meta(15, 1),          # 入帳到 08/12
    FED_LINE:                     meta(15, 1),
    '聯邦 LINE Bank Visa 1308':   meta(15, 1),
    '中信 All Me 萬事達 4511':     meta(25, 10),         # 入帳到 08/24
    '中信 LINE Pay JCB 6357':     meta(25, 10),
